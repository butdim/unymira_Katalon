...
WebUI.mouseOver(findTestObject('x/Page_Filialsuche - BVR HTML Prototy/div_Berlin'))

WebUI.delay(2)

WebUI.click(findTestObject('x/Page_Filialsuche - BVR HTML Prototy/div_Berlin'))
